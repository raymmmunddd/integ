    ...
    <div :class="['sidebar', { 'sidebar-closed': isClosed }]">
      ...
      <ul class="menu">
        <li>
          ...
          <RouterLink to="/dashboard" class="a" v-if="!isClosed">Dashboard</RouterLink>
        </li>
        <li>
          <i class="bx bx-history"></i>
          <RouterLink to="/medHistory" class="a" v-if="!isClosed">Medical History</RouterLink>
        </li>
        <li>
          <i class="bx bx-list-ul"></i>
          <RouterLink to="/TherapistList" class="a" v-if="!isClosed">Therapist Lists</RouterLink>
        </li>
        <li>
          <i class='bxr bx-message-question-mark'></i> 
          <RouterLink to="/StudentForum" class="a" v-if="!isClosed">Forum</RouterLink>
        </li>
